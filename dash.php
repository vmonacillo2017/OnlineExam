...
<nav class="navbar navbar-default title1">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="dash.php?q=0"><b>Administration Dashboard</b></a>
    </div>
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="right" name="right" placeholder="Enter points on each correct answer" class="form-control input-md" min="0" type="number">
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <textarea rows="8" cols="8" name="desc" class="form-control" placeholder="Write description and instructions here..."></textarea>  
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="'.$i.'1" name="'.$i.'1" placeholder="Enter choice a" class="form-control input-md" type="text">
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="'.$i.'2" name="'.$i.'2" placeholder="Enter choice b" class="form-control input-md" type="text">
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="'.$i.'3" name="'.$i.'3" placeholder="Enter choice c" class="form-control input-md" type="text">
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="'.$i.'4" name="'.$i.'4" placeholder="Enter choice d" class="form-control input-md" type="text">
...
<select id="ans'.$i.'" name="ans'.$i.'" placeholder="Choose correct answer " class="form-control input-md" >
  ...
  <option value="d">choice d</option> </select><br /><br />'; 
 }
            ...
            <div class="row">
                ...
                <form class="form-horizontal" action="functions.php" method="post" name="upload_excel" enctype="multipart/form-data">
                    <fieldset>
                        ...
                        <!-- Button -->
                        <div class="form-group">
                            <label class="col-md-4 control-label" for="singlebutton">Upload Employee Info</label>
                            <div class="col-md-4">
                                <button type="submit" id="submit" name="Upload" class="btn btn-primary button-loading" data-loading-text="Loading...">Upload</button>
                            </div>
                        </div>
